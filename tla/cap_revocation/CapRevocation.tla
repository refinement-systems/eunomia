...
\* The safety arm's symmetry permutes BOTH sets. TLC's idiom for a symmetry over
\* two disjoint model-value sets is the union of their Permutations (the group
\* generated by both). Named by CapRevocation_Safety.cfg and its three symmetric
\* negative controls; NEVER the liveness arm.
SafetySymmetry == ProcSymmetry \cup CapSymmetry
